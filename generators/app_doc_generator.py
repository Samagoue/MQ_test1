...
class ApplicationDocGenerator:
    ...
    def generate_app_page(self, app_name: str) -> Optional[str]:
        ...
        # ---- Timestamp box ----
        lines.extend([
            "{panel:bgColor=#e8eaf6|borderColor=#7986cb|borderStyle=solid}",
            f"||Last Updated|| {timestamp} ||",
            f"||Generated By|| MQ CMDB Pipeline ||",
            "{panel}",
            "",
        ])
        ...
        lines.extend([
            ...
            *_styled_panel(
                ...
                [
                    f"_This TOGAF-aligned Enterprise Architecture documentation was automatically generated on {timestamp}_",
                    "_by MQ CMDB Automated Documentation System_",
                    "",
                    f"*Document Version:* 1.0 | *Framework:* TOGAF 9.2 | *Classification:* {_status_lozenge('Internal', 'Blue')} | {_status_lozenge('AUTO-GENERATED', 'Grey')}",
                ],
                bg_color="#f0f0f0",
                title_bg="#2d3e50",
                title_color="#ffffff",
