...
print_banner() {
    ...
    echo -e "${CYAN}"
    python3 -c "from utils.logging_config import generate_ascii_art; [print(line) for line in generate_ascii_art('MQ CMDB')]" 2>/dev/null || echo "  MQ CMDB Pipeline Runner"
    echo ""
